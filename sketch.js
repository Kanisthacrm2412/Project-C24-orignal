...
function setup() {
  ...
  playerArcher = new PlayerArcher(width - 640,playerBase.body.position.y - 180,120,120);
 ...
 arrow = new PlayerArrow(playerArcher.body.position.x,playerArcher.body.position.y,120,120);
